...
func assert_signal_emitted(object, signal_name, text=""):
	...
	if(_can_make_signal_assertions(object, signal_name)):
		if(_signal_watcher.did_emit(object, signal_name)):
			...
			_fail(disp)
func assert_signal_emitted2(object, signal_name, text=""):
	var disp = str('Expected object ', object, ' to emit signal [', signal_name, ']:  ', text)
	if(_can_make_signal_assertions(object, signal_name)):
		if(_signal_watcher.did_emit(object, signal_name)):
			_pass(disp)
			...
			_fail(disp)
func assert_signal_emitted3(object, signal_name, text=""):
	var disp = str('Expected object ', object, ' to emit signal [', signal_name, ']:  ', text)
	if(_can_make_signal_assertions(object, signal_name)):
		if(_signal_watcher.did_emit(object, signal_name)):
			_pass(disp)
			...
			_fail(disp)
func assert_signal_emitted4(object, signal_name, text=""):
	var disp = str('Expected object ', object, ' to emit signal [', signal_name, ']:  ', text)
	if(_can_make_signal_assertions(object, signal_name)):
		if(_signal_watcher.did_emit(object, signal_name)):
			_pass(disp)
			...
			_fail(disp)
func assert_signal_emitted5(object, signal_name, text=""):
	var disp = str('Expected object ', object, ' to emit signal [', signal_name, ']:  ', text)
	if(_can_make_signal_assertions(object, signal_name)):
		if(_signal_watcher.did_emit(object, signal_name)):
			_pass(disp)
			...
			_fail(disp)
func assert_signal_emitted6(object, signal_name, text=""):
	var disp = str('Expected object ', object, ' to emit signal [', signal_name, ']:  ', text)
	if(_can_make_signal_assertions(object, signal_name)):
		if(_signal_watcher.did_emit(object, signal_name)):
			_pass(disp)
			...
			_fail(disp)
func assert_signal_emitted7(object, signal_name, text=""):
	var disp = str('Expected object ', object, ' to emit signal [', signal_name, ']:  ', text)
	if(_can_make_signal_assertions(object, signal_name)):
		if(_signal_watcher.did_emit(object, signal_name)):
			_pass(disp)
			...
			_fail(disp)
func assert_signal_emitted8(object, signal_name, text=""):
	var disp = str('Expected object ', object, ' to emit signal [', signal_name, ']:  ', text)
	if(_can_make_signal_assertions(object, signal_name)):
		if(_signal_watcher.did_emit(object, signal_name)):
			_pass(disp)
...
func assert_signal_emitted9(object, signal_name, text=""):
	var disp = str('Expected object ', object, ' to emit signal [', signal_name, ']:  ', text)
	if(_can_make_signal_assertions(object, signal_name)):
		if(_signal_watcher.did_emit(object, signal_name)):
			_pass(disp)
